    ...
    return (
        ...
        >
            ...
            <div className='flex pt-[50px]  xl:mx-[86px] gap-[18px] overflow-auto flex-col lg:flex-row justify-center  '>
                <div className='flex flex-col items-center bg-blue-dark opacity-80  max-h-max rounded-3xl  pb-6 left-anim sm:secondleft-anim '>
                ...
                <div className='flex secondleft-anim sm:left-anim flex-col bg-blue-dark  opacity-80 rounded-3xl  px-3 md:px-6 pb-6  items-center max-h-max '>
