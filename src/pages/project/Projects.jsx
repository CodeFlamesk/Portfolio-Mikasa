        ...
        <div className="w-full min-h-screen relative flex justify-center px-10 pb-10">
            ...
            <div className="flex  flex-col z-10 items-center select-none ">
                ...
                <div className='grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 lg:gap-[102px] h-850:pt-0 pt-4'>
                    <div className='thirdleft-anim order-3 sm:order-1 hover:rotate-project'>
                    ...
                    <div className='secondleft-anim order-2 hover:rotate-project'>
                    ...
                    <div className='left-anim order-1 sm:order-3 hover:rotate-project'>
