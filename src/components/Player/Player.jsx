        ...
        <div>
            ...
            <div className="controls">
                <button onClick={togglePlayPause} >
                    ...
                    <div className="z-10 absolute right-24  md:bottom-4 rounded-full  ">{isPlaying ? <PauseIcon /> : <PlayIcon />}</div>
                    {!showVolume && (<div className="play-btn-play"></div>)}

                </button>
                <button onClick={() => setShowVolume(!showVolume)} >
                    <div className="z-10 absolute right-6 md:bottom-4 rounded-full">
                        <VolumeSeting />
                    </div>
